...
import {scrollInterpolators, animatedStyles} from './util/animations';
...
export default class CarouselPage extends Component {
    ...
    layoutExample(number, title, type) {
        ...
        return (
            <View
                style={[styles.exampleContainer, isTinder ? styles.exampleContainerDark : styles.exampleContainerLight]}>
